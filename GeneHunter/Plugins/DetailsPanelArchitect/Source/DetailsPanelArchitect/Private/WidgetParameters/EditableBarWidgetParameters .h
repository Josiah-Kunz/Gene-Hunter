...
#pragma region Default values
	...
	FVector2D EditableTextBoxSize = FVector2D{50, 20};
	...
	FVector2D SlashPosition = FVector2D{80, 0};
	...
	FVector2D MaxPosition = FVector2D{90, 0};
	...
	FVector2D BarPosition = FVector2D{140, 0};
