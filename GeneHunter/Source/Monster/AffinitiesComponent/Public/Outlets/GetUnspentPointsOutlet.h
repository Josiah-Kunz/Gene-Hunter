...
struct LEVELCOMPONENT_API FBeforeGetUnspentPointsDelegate : public FEffectDelegate_Base
{
	GENERATED_BODY()
 ...
 */
USTRUCT(Blueprintable)
struct LEVELCOMPONENT_API FAfterGetUnspentPointsDelegate : public FEffectDelegate_Base
{
	GENERATED_BODY()
 ...
 */
USTRUCT(Blueprintable)
struct LEVELCOMPONENT_API FGetUnspentPointsOutlet : public FEffectOutlet_Base
{
	GENERATED_BODY()
