...
struct LEVELCOMPONENT_API FBeforeModifyStatDelegate : public FEffectDelegate_Base
{
	GENERATED_BODY()
 ...
 */
USTRUCT(Blueprintable)
struct LEVELCOMPONENT_API FAfterModifyStatDelegate : public FEffectDelegate_Base
{
	GENERATED_BODY()
 ...
 */
USTRUCT(Blueprintable)
struct LEVELCOMPONENT_API FModifyStatOutlet : public FEffectOutlet_Base
{
	GENERATED_BODY()
