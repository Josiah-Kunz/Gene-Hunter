...
\graphic{filename=base-pairs-vs-attack-plot,
		caption={Base pair count vs.\ the Physical Attack stat for a Monster at level 100 with an average base Physical Attack (100). The ``wiggles'' in the plot are from the way PhA is calculated (via floor function).},
