...
\graphic{filename=../Stats-Documentation/stat-key,
			captionType=table, 
...
\graphic{filename=../Stats-Documentation/color-key,
			captionType=table, 
...
\graphic{filename=../Stats-Documentation/base-pairs-mockup,
...
\graphic{filename=../Stats-Documentation/base-pairs-vs-attack-plot,
...
\graphic{filename=../Stats-Documentation/mutations-table,
...
\graphic{filename=../Stats-Documentation/Standard-stat-low-levels-100-plot, 
			caption={The early game plot of a standard stat by level for a base pair value of 100.},
			label={fig: standard-early-game},
			width=\textwidth
}
			
\graphic{filename=../Stats-Documentation/Standard-stat-low-levels-100-table, 
...
\graphic{filename=../Stats-Documentation/Haste-CD-reduction-table,
...
\graphic{filename=../Stats-Documentation/exp-yield-analysis-plot, width=\textwidth, 
...
\graphic{filename=../Stats-Documentation/exp-yield-analysis-table, width=\textwidth,
	caption={Number of Monsters of equal level to KO in order to level up. For example, assuming a base yield of 1, a Monster at level~50 must KO 18.2 level-50-Monsters in order to reach level~51.}
}

\noindent Of course, it's also useful to see the numbers if the player is punching up at a +2 level difference:

\graphic{filename=../Stats-Documentation/exp-yield-analysis-enemy-plus2-plot, width=\textwidth, 
	caption={Figure~\ref{fig: exp-yield-analysis-plot}, but with the enemy at +2 levels.}
}

\graphic{filename=../Stats-Documentation/exp-yield-analysis-enemy-plus2-table, width=\textwidth,
