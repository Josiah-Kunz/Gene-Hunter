...
\begin{itemize}
	...
	\bitem{Effects to inflict}{A \code{TArray} of \code{EffectsToImplement}s. This includes the Effect and its percentage of being applied on a successful Move hit. Pok\'{e}mon example: a Move having 30\% chance to Burn would have its \code{TPair} be \code{Burn} and \code{30}.}
