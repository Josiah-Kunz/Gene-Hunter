...
\end{align*}
Clearly, the Defense of the healee should not inhibit the heal, so a static 100 has been used instead (since 100 is an average stat). Moreover, Type advantages should not play a role in healing. Heals can crit, though.
