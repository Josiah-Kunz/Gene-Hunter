...
\begin{itemize}
	...
	\item{\ul{should} be added just after its \code{Owner} is added. See how to attach below.}
	\item{\ul{should} be destroyed just before its \code{Owner} is destroyed. This should happen via destroy and unregister. See below.}
...
\end{lstlisting}
Finally, when you destroy \code{UBerserkerGene}, make sure you also destroy \code{UPermStatMod}:
\begin{lstlisting}[language=C++]
