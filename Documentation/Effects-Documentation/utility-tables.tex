...
\end{lstlisting}
You can also initialize things on the \code{UDependentEffectComponent} side of things. For example, if you wanted to make sure there were stats attached to the new owner:
\begin{lstlisting}[language=c++]
