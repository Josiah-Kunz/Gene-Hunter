...
\begin{tldr}
	\begin{itemize}
		\item{\code{EffectableComponents} can have effects.}
		\item{\code{Outlet}s are places in the code for effects to ``plug into''.}
		\item{There are a bunch of types of effects, like \code{Aura}s, \code{Trait}s, and \code{HoT}s.}
		\item{Effects themselves are \code{EffectableComponent}s.}
	\end{itemize}
\end{tldr}
...
\begin{itemize}
	\item{\textbf{\code{EffectableComponent}s} are \code{ActorComponent}s that allow for delegation (effects). They have predefined places called ``\code{Outlet}s'' that allow for code modification. Think of \code{Outlet}s like electrical outlets waiting to be plugged into.
		...
		\begin{center}
			\includegraphics[scale=\ScreenshotScale]{../Effects-Documentation/recalculate-stats-code}
		\end{center}
		}
	\item{\textbf{\code{EffectComponent}s} plug into these \code{Outlet}s. These come in many forms, but an easy example is a \code{Buff}. Take \code{Invulnerable}, which plugs into \code{StatComponent}'s ``before modify stat'' \code{Outlet}:
		\begin{center}
			\includegraphics[scale=\ScreenshotScale]{../Effects-Documentation/invulnerable}
		\end{center}
	}
\end{itemize}
...
\input{../Effects-Documentation/effects-inheritance}
...
\end{enumerate}
See the section on making your own \code{Outlet} for more information on how these layers work together.
...
\input{../Effects-Documentation/outlets-tables}
...
\begin{enumerate}
	...
	\begin{center}
		\includegraphics[scale=\ScreenshotScale]{../Effects-Documentation/create-outlet-rename}
	\end{center}
	...
	\begin{center}
		\includegraphics[scale=\ScreenshotScale]{../Effects-Documentation/create-outlet-signature}
	\end{center}
	...
	\begin{center}
		\includegraphics[scale=\ScreenshotScale]{../Effects-Documentation/create-outlet-api}
	\end{center}
	}
	...
	\begin{center}
		\includegraphics[scale=\ScreenshotScale]{../Effects-Documentation/create-outlet-functions}
	\end{center}
		\begin{itemize}
	...
	\begin{center}
		\includegraphics[scale=\ScreenshotScale]{../Effects-Documentation/create-outlet-uproperty}
	\end{center}
	...
	\begin{center}
		\includegraphics[scale=\ScreenshotScale]{../Effects-Documentation/create-outlet-cpp}
	\end{center}
...
\sect{All \code{Effects}}

\input{../Effects-Documentation/effect-tables}

\sect{Dependent Effects}

\input{../Effects-Documentation/dependent-effects}
