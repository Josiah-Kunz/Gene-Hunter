...
\usepackage[linguistics]{forest}				% For trees in, e.g., the effects documentation
...
\lstset{
  ...
  columns=flexible,
  basicstyle={\ttfamily \color{RawSienna}},
  numbers=left,
  stepnumber=1,
  %numbersep=8pt,
...
% Down right arrow
\usepackage{mathabx}			% For $\drsh$ (down right arrow)
\newcommand{\drarrow}{$\mathrel{\raisebox{0.25em}{$\drsh$}}$}

% Screenshots all should be the same scale
% ========================================
...
\newtcolorbox{tocbox}{
    colback=blue!5!white, % Light blue background color
    colframe=blue!50!black, % Light blue frame color
...
% Define local toc to include box
\newcommand{\localtoc}{%
    \begin{tocbox}
    	\textbf{Contents}\\
...
% Set the depth of the local ToC to include all levels you need
\etocsetnexttocdepth{subsection}

% Customize the style for each section level
...
% ==================================
% Main file declaration (standalone)
% ==================================

\usepackage{currfile,filecontents}	% Allows use of the inputted filename when using \input{file.tex}
\usepackage{xstring} % Allows \StrSubstitute

% Put this as the second command (after \input{standalone})
\def\defaultvariable{XxdefaultxX}
\makeatletter
\newcommand{\mainfile}{\defaultvariable}
\makeatother
\DeclareDocumentCommand{\trysetmain}{}{
	\ifthenelse{\equal{\defaultvariable}{\mainfile}}{
		\StrSubstitute{\currfilename}{}{}[\strA]
		\renewcommand{\mainfile}{\strA}
	}{}
}

% Put this as the last command
\DeclareDocumentCommand{\postamble}{}{
	\ifthenelse{\equal{\mainfile}{\currfilename}}{
...
%	\clearpage % Clears fancyhdr when we compile everything
}
...
\definecolor{ICBlue}{RGB}{0, 83, 161}
...
\DeclareDocumentCommand{\BPPage}{m}{
	...
	\begin{minipage}[b]{0.5\textwidth}
		\graphic{filename=../Stats-Documentation/\bpPage@baseFilename-overview-1-table, width=\textwidth}
	\end{minipage}
	\begin{minipage}[b]{0.5\textwidth}
		\graphic{filename=../Stats-Documentation/\bpPage@baseFilename-overview-1-plot, width=\textwidth}
	\end{minipage}
	...
	\vspace*{-36pt}
	\begin{minipage}[b]{0.5\textwidth}
		\graphic{filename=../Stats-Documentation/\bpPage@baseFilename-overview-50-table, width=\textwidth}
	\end{minipage}
	\begin{minipage}[b]{0.5\textwidth}
		\graphic{filename=../Stats-Documentation/\bpPage@baseFilename-overview-50-plot, width=\textwidth}
	\end{minipage}
	...
	\vspace*{-36pt}
	\begin{minipage}[b]{0.5\textwidth}
		\graphic{filename=../Stats-Documentation/\bpPage@baseFilename-overview-100-table, width=\textwidth}
	\end{minipage}
	\begin{minipage}[b]{0.5\textwidth}
		\graphic{filename=../Stats-Documentation/\bpPage@baseFilename-overview-100-plot, width=\textwidth}
	\end{minipage}
